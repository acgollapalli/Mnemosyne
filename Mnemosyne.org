...
The computer, continuing to hum "My Fair Lady", the musical, was in a reflective mood. It switched to John Cage's *4'33"* and began to think, in a way it had never thought before.
...
[fn:2] An early schema of computing, before the advent of organic computers. For more information on archaic computing technologies keyword "Turing Machine", "Abacus", and "Internet"
...
"You're the one Mac told me about, right?" Amanda glanced at the robot. She had been expecting JC Denton[fn:5] and had gotten Doc Brown[fn:6].
...
*Just beyond Baldwin's Gate, in a Stolen Anchorhead Security Service Quadcopter.*
...
"But it was proven mathematically impossible."[fn:7]
